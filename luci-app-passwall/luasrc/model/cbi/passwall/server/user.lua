...
tls_certificateFile = s:option(FileUpload, "tls_certificateFile", translate("Public key absolute path"))
...
tls_keyFile = s:option(FileUpload, "tls_keyFile", translate("Private key absolute path"))
...
acceptProxyProtocol = s:option(Flag, "acceptProxyProtocol", translate("acceptProxyProtocol"))
...
fallback_list = s:option(DynamicList, "fallback_list", translate("Fallback"))
...
remote_enable = s:option(Flag, "remote_enable", translate("Enable Remote"))
