...
o:value("https://fastly.jsdelivr.net/gh/gfwlist/gfwlist/gfwlist.txt", translate("gfwlist"))
...
if has_v2ray or has_xray then
    o = s:option(Value, "v2ray_location_asset", translate("Location of V2ray/Xray asset"))
    o.default = "/usr/share/v2ray/"
    o.rmempty = false
    
    s = m:section(TypedSection, "shunt_rules", translate("Shunt Rule"))
