...
if has_v2ray or has_xray then
    o = s:option(Flag, "sniffing", translate("Sniffing (V2Ray/Xray)"))
    o.default = 1
    o.rmempty = false

    if has_xray then
        route_only = s:option(Flag, "route_only", translate("Sniffing Route Only (Xray)"))
        ...
        o = s:option(TextValue, "no_sniffing_hosts", translate("No Sniffing Lists"))
        o.rows = 5
        o.wrap = "off"
        ...
        o = s:option(Value, "buffer_size", translate("Buffer Size (Xray)"))
        o.rmempty = true
        o.datatype = "uinteger"
    end
end
