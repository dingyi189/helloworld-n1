...
o = s:option(Value, "testing_time", translate("How often to test"))
o.datatype = "uinteger"
o.default = 1

o = s:option(Value, "connect_timeout", translate("Timeout seconds"))
o.datatype = "uinteger"
o.default = 3
...
o = s:option(DynamicList, "tcp_node", translate("List of backup nodes"))
...
o = s:option(Flag, "restore_switch", translate("Restore Switch"))
